  ...
  <div class="sermon-shell">
    <div class="sermon-shell-nav">
      ...
      <nav class="sermon-shell-links">
        ...
        <a class="sermon-pill active" href="/teachings.html">Teachings</a>
    ...
    <div class="sermon-hero-grid">
      <div class="sermon-hero-text">
        ...
        <h1>Teachings That Grow Your Faith</h1>
        <p class="sermon-hero-sub">
          Deepen your understanding of Scripture with practical lessons that build discipline, confidence, and purpose.
        </p>
        <div class="sermon-hero-actions">
          <a class="play sermon-primary" href="#teaching-library">Browse Teachings</a>
          <a class="ghost-btn sermon-secondary" href="/sermons.html">See Sermons</a>
        </div>
        <div class="sermon-hero-meta">
          ...
          <div class="sermon-meta-text">
            Weekly studies • Small-group friendly
          </div>
        </div>
      </div>
    ...
    <div class="sermon-latest" id="teaching-library">
      ...
      <div class="sermon-latest-row">
        {% for item in collections.teachings | reverse %}
        <a class="sermon-latest-card" href="{{ item.url }}">
          ...
          <div class="sermon-latest-meta">
            ...
            <p>{{ item.data.category or "Teaching" }} • {{ item.date | year }}</p>
          </div>
        </a>
        {% endfor %}
      </div>
